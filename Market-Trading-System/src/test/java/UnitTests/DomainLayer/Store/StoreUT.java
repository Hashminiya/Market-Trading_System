...
import DomainLayer.Repositories.InMemoryItemRepository;
...
public class StoreUT {
    ...
    @Mock
    private InMemoryItemRepository itemMock;
    @Mock
    private InMemoryDiscountRepository discountsMock;
    @Mock
    private InMemoryPurchaseRepository policiesMock;
    ...
    void setUp() {
        ...
        store = new Store(STORE_ID, FOUNDER_ID, STORE_NAME, STORE_DESCRIPTION, itemMock, discountsMock);
    }
